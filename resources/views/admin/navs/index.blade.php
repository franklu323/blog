...
@section('content')
        ...
        <div class="crumb_warp">
            ...
            <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">Home</a> &raquo; Navigation Bar
        </div>
        <!--面包屑导航 结束-->
            ...
            <div class="result_wrap">
                ...
                <div class="result_content">
                    <div class="short_wrap">
                        <a href="{{url('admin/navs/create')}}"><i class="fa fa-plus"></i>Add Navigation</a>
                        <a href="{{url('admin/navs')}}"><i class="fa fa-recycle"></i>All Navigation</a>
                    </div>
                </div>
                <!--快捷导航 结束-->
            </div>
                ...
                <div class="result_content">
                    <table class="list_tab">
                        <tr>
                            ...
                            <th>Navigation Alias</th>
                            <th>Navigation Address</th>
                            <th>Changes</th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>{{$v->nav_url}}</td>
                            <td>
                                <a href="{{url('admin/navs/'.$v->nav_id.'/edit ')}}">Modify</a>
                                <a href="javascript:;" onclick="delNavs({{$v->nav_id}})">Delete</a>
                            </td>
                        </tr>
                        @endforeach
