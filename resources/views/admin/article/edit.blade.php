            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img alt="" id="art_thumb_img" style="max-width:350px; max-height:100px" src="/{{$field->art_thumb}}">  {{--显示图片--}}
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <script id="editor" name="art_content" type="text/plain" style="width:590px;height:300px;"> {!! $field->art_content !!} </script>
                            <script type="text/javascript">
